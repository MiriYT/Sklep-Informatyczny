...
--
ALTER TABLE `klienci`
  ADD CONSTRAINT `fk_klienci_recenzje` FOREIGN KEY (`idklienta`) REFERENCES `recenzje` (`idklienta`);

--
-- Constraints for table `recenzje`
--
ALTER TABLE `recenzje`
  ADD CONSTRAINT `recenzje_ibfk_1` FOREIGN KEY (`idproduktu`) REFERENCES `produkty` (`idproduktu`);

--
-- Constraints for table `serwis`
--
ALTER TABLE `serwis`
  ADD CONSTRAINT `serwis_ibfk_1` FOREIGN KEY (`idproduktu`) REFERENCES `produkty` (`idproduktu`),
  ADD CONSTRAINT `serwis_ibfk_2` FOREIGN KEY (`idpracownika`) REFERENCES `pracownicy` (`idpracownika`);
